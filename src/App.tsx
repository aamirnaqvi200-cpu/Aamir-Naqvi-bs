...
>
  ...
  <div className="absolute inset-0 bg-black/0" />
      ...
      <div 
        ...
        className="relative w-full bg-[#232F3E] z-[100] rounded-t-[3rem] rounded-b-[3rem] opacity-100"
        style={{ 
          minHeight: window.innerWidth < 768 ? 'calc(var(--mobile-vh) * 100)' : '100vh',
          zIndex: 9999 
        }}
